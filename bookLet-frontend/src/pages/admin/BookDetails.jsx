            ...
            {reviews.length === 0 ? (
              ...
              <div className="space-y-6">
                {reviews.map((review, index) => {
                  ...
                  const firstLetter = (review.username || "Anonymous")
                    .charAt(0)
                    .toUpperCase();
                  ...
                  return (
                    <div
                      key={index}
                      className="flex border-b border-gray-100 pb-6 last:border-b-0"
                    >
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg ${avatarColor} mr-4 flex-shrink-0`}
                      >
                        {firstLetter}
                      </div>
